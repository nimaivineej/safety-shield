        ...
        <div className="bg-white rounded-3xl shadow-md overflow-hidden">
          <div className="p-4 border-b border-gray-100">
            <h2 className="font-bold text-gray-900 flex items-center gap-2">
              <MapPin className="w-5 h-5 text-purple-600" /> Location Accuracy
            </h2>
          </div>
          {[
            { key: 'highAccuracy', icon: Navigation, label: 'High Accuracy GPS', sub: 'Uses more battery', color: 'text-purple-600', bg: 'bg-purple-100' },
